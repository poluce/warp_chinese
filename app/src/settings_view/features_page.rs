...
fn block_maximum_rows_description() -> String {
    ...
    format!(
        "将限制设置在 10 万行以上可能影响性能。支持的最大行数为 {max_rows}。"
    )
}
    ...
    fn render_change_keybinding_button(
        ...
        Hoverable::new(
            ...
            |state| {
                ...
                Container::new(
                    Text::new_inline("修改快捷键", appearance.ui_font_family(), 12.)
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            ...
            ui_builder
                ...
                .finish(),
            Some("启用后，代码审查面板将在对话首次接受差异时打开".into()),
        )
    }
}
...
impl SettingsWidget for WindowSystemWidget {
    ...
    fn render(
        ...
        let mut secondary_text =
            "启用此设置将禁用全局热键支持。禁用后，如果 Wayland 合成器使用分数缩放（如 125%），文本可能模糊。"
                .to_string();
