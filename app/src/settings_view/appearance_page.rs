...
impl AppearanceSettingsPageView {
    ...
    fn workspace_decoration_visibility_dropdown_item_label(
        ...
        match value {
            ...
            WorkspaceDecorationVisibility::OnHover => "仅在悬停时",
        }
    }
...
impl SettingsWidget for CustomAppIconWidget {
    ...
    fn render(
        ...
        let dropdown = render_dropdown_item(
            appearance,
            "自定义应用图标",
            show_bundle_warning.then_some("更改应用图标需要应用被打包。"),
            None,
                ...
                return Flex::column()
                    ...
                    .with_child(
                        appearance
                            .ui_builder()
                            .wrappable_text(
                                "可能需要重启 Warp 才能使 macOS 应用首选图标样式。",
                                true,
                            )
            ...
            match is_vim_mode_enabled {
                true => Flex::column()
                    .with_child(
                        appearance
                            .ui_builder()
                            .span("光标类型在 Vim 模式下已禁用".to_string())
                            .build()
                            .finish(),
                    )
                    .finish(),
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            ...
            appearance
                ...
                .finish(),
            Some(
                "在垂直标签页中，为 Oz 和第三方 Agent 会话显示最新的用户提示，而非生成的对话标题。"
                    .to_string(),
            ),
        )
    }
