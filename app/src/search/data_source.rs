...
impl QueryFilter {
    ...
    pub fn placeholder_text(&self) -> &'static str {
        match self {
            ...
            QueryFilter::AgentModeWorkflows => "搜索提示",
            QueryFilter::Notebooks => "搜索笔记本",
            QueryFilter::Plans => "搜索计划",
            QueryFilter::NaturalLanguage => "例如在文件中替换字符串",
            ...
            QueryFilter::Drive => "搜索 Drive 中的对象",
            QueryFilter::EnvironmentVariables => "搜索环境变量",
            QueryFilter::PromptHistory => "搜索提示历史",
            ...
            QueryFilter::FullTerminalUseModels => "搜索全终端使用模型",
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ...
            QueryFilter::AgentModeWorkflows => "提示",
            ...
            QueryFilter::PromptHistory => "提示历史",
            ...
            QueryFilter::FullTerminalUseModels => "全终端使用模型",
